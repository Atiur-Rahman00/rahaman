        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="contact-form">
              ...
              <?php if(isset($_SESSION['guest_message_done'])):?>
                    <small class="text-success mb-10 bg-white"><?=$_SESSION['guest_message_done']?></small>
                    <?php unset($_SESSION['guest_message_done']) ?>
                <?php endif ?>
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_email" type="text" class="form-control" id="email" placeholder="E-Mail Address">
                    </fieldset>
